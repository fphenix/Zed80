...
void initKB() {
  ...
  String[] serialKBstrAZERTY_Maj = {"UP", "RIGHT", "DOWN", "F9", "F6", "F3", "ENTER","DOT", "LEFT", "COPY", "F7", "F8", "F5", "F1", "F2", "F0", "CLR", "<", "RETURN", ">", "F4", "SHIFT", "$", "CTRL", "_", "[", "^", "P", "%", "M", "+", "/", "0", "9", "O", "I", "L", "K", "?", ".", "8", "7", "U", "Y", "H", "J", "N", "SPACE", "6_J2UP", "5_J2DOWN", "J2LEFT", "J2RIGHT", "J2FIRE2", "J2FIRE1", "J2FIRE0", "V", "4", "3", "E", "Z", "S", "D", "C", "X", "1", "2", "ESC", "A", "TAB", "Q", "CAPS", "W", "J1UP", "J1DOWN", "J1LEFT", "J1RIGHT", "J1FIRE2", "J1FIRE1", "J1FIRE0", "DEL"};
